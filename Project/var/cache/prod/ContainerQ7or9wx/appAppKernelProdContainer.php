...
class appAppKernelProdContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Y49OWS9PFM', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '', 'dbname' => 'prestashop_db', 'user' => 'root', 'password' => '', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gzloTE457H', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fdeNzMGGMp', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tbI1NF-PvN', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UVPgZ071Nn', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pyzWx2Jk+N', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('K+eh1UZb1p', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XdCKW2ALM6', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PQ6vpWxejB', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lYhCJ3M-as', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('wWU5nQ2Env', 0, $this->getParameter('container.build_id'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PHi30l4dp5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oPDo4pbtFB', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vCuz83jojS', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('g7xBDMXbo7', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('5Q7t3Cyf4EyJZ6OeDTAWiSYKL82XkcTcwfdiiVKkS37IEm1bfPTfcobWE7EwH8a7'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                14 => 'pagesnotfound',
                15 => 'ps_brandlist',
                16 => 'ps_categoryproducts',
                17 => 'ps_crossselling',
                18 => 'ps_dataprivacy',
                19 => 'ps_distributionapiclient',
                20 => 'ps_emailalerts',
            ...
            'secret' => '5Q7t3Cyf4EyJZ6OeDTAWiSYKL82XkcTcwfdiiVKkS37IEm1bfPTfcobWE7EwH8a7',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2024-02-11',
            'locale' => 'en-US',
            'use_debug_toolbar' => true,
            'cookie_key' => 'I3eSSXUNGQetzCLjnDxcxvySFTntnkQ69mEy5jXy1hrvVvzegbxVJmAw4FD60uyA',
            'cookie_iv' => 'ekeP2an2iFSZdTtLMnhK5foHSuunQHZt',
            'new_cookie_key' => 'def000004bb8c04874bf27bc0d1827f9263d8f1f9eb470f6c7bb447afdf8f6ed268def87f7ec961ad6588769340f0bff46c05c36e9abb805b6a897dd20a4644432fb197a',
            'api_public_key' => '-----BEGIN PUBLIC KEY-----'."\n".'MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAoNq9ZQAWyCZVpMyteVW7'."\n".'gaarYiQaMdMh7Io/49K0L9l7TGXcRz016qiQfKCOy/MgJbCjNT992yyh/5431Yji'."\n".'ttLXBfF0njVrvn5GFCNnr7FRCaGEz4OllLMaPmtFa+kQy2qMYyCqeUX+3wouYnRo'."\n".'zzzLdCN4HJ8oZetgqdFEfDQ2VxKwsQlMVpRXCHTesq5PsXbk2AuzfY0oAJGORnGf'."\n".'j/DXmQF0G1yu6Ta9tOkhcrRCeEw05SNtUbRpbLYNWDi3umNyHjOHJHlm8YdEtnGW'."\n".'GFVd/XaLXNjtGYog8COiRB1r4/vsGwudP4eT78jnmb1hqvzICEXNhifnooKe+ujT'."\n".'ZQIDAQAB'."\n".'-----END PUBLIC KEY-----'."\n".'',
            'api_private_key' => '-----BEGIN PRIVATE KEY-----'."\n".'MIIEuwIBADANBgkqhkiG9w0BAQEFAASCBKUwggShAgEAAoIBAQCg2r1lABbIJlWk'."\n".'zK15VbuBpqtiJBox0yHsij/j0rQv2XtMZdxHPTXqqJB8oI7L8yAlsKM1P33bLKH/'."\n".'njfViOK20tcF8XSeNWu+fkYUI2evsVEJoYTPg6WUsxo+a0Vr6RDLaoxjIKp5Rf7f'."\n".'Ci5idGjPPMt0I3gcnyhl62Cp0UR8NDZXErCxCUxWlFcIdN6yrk+xduTYC7N9jSgA'."\n".'kY5GcZ+P8NeZAXQbXK7pNr206SFytEJ4TDTlI21RtGlstg1YOLe6Y3IeM4ckeWbx'."\n".'h0S2cZYYVV39dotc2O0ZiiDwI6JEHWvj++wbC50/h5PvyOeZvWGq/MgIRc2GJ+ei'."\n".'gp766NNlAgMBAAECgf87mFHR3awgLRj2cIsD8604+yE66iqBK99I+qumpSiqFFR9'."\n".'afFfL4VPiA9jVpZ3HhyZUlg1G6xOilJBRZlP+VolI2tSoS/AFQq5bD5GldI/m91s'."\n".'6uVrvfnmnc2GchNTZ6WASjBbEW4208pTb9Le9aAoYSb1WzQDExPnLDtir0eofWzL'."\n".'0sSHhJrRfUGjxgcDf5M02Q5sGOeMkgoMux08KbagIvNpIJoSXBCtQIHdWPGNLKeN'."\n".'buyqm72ESko6jXU803Jp5PeuWcZc4a6Bv6B/a994b97IM46rqBlYv24xCslNxDLT'."\n".'82gfSiXDpdxcp9PSmcWxtqFUkA2ereuPN6q2cCECgYEAwzOIvl1LaUxFYZ1PRPWx'."\n".'dREGyxKukR8ZfYNqxRXq21ItipFWePqV+pN7gadzZ1FgtzAD9tav4NIif/DqO8A9'."\n".'G1Cj7svW/UF9RVBSLS2tdPFD5t4OFTvdRtnmPZrdfcSBdUWxph3twpzmYDCD9pHO'."\n".'dwrLR+ZSfabWLXdk31xLdPUCgYEA0vSLJrk0lmuiguHojsXJYxgKCbqJ1XaJKGph'."\n".'6oY7VNrvb9pfA8omwiw5UcVq164MgkwYBictg59okgPkPXZjBxinKAmlelPlkJfr'."\n".'4hJ0TgHLR0Ucr+0tkjB3EskwOVKhBlZ/u135WW3xnevexib5WLZ1UF4Tmi7PbgEo'."\n".'J4e/XrECgYEAqP2Xd77LB4kJU93df4T5MbEg4XP1/xsedUPtjlxQK7m0RY9Xfnrq'."\n".'lrlRpkhyp1KTWWRPOkZYk1k4luzZzAq8nEYu9hAwuqYUroo/6m7uCRzKPTeml4lx'."\n".'IuKH6nOFJ1mU/hLtHjQw31f4NfQqeq92QCbvH/rtFWz3ZPtFL/32MXUCgYA8lRgl'."\n".'Pcj5bd3U4pXL8sc8Gxo+4wBUel83aR3HoVcGrn1WzQq+Zt6sotCvSBe/6u8SuFGp'."\n".'6rRqeWwpis6QTCByWEUg/Ww1bkSeOtL2MMCP6nn7dMChUWbl9d8sWPTtcWpnDI5Q'."\n".'O9OxOB7McIGgvG6daIDWXL4aaFkPyWtDtvthcQKBgE462mxtL+eLQU++QmMnPQkJ'."\n".'cpYmuO6IjxPQ+moS/OSC5zcnMIwY4qlH1laubq2svGTERm1ocK+4GoYWb8XDc1uH'."\n".'8Ru6m8bWjxjJGBSWuzWdNPJdS8L4M5ucfGu31CEtzDzImUn225aVDtiMgci7dG22'."\n".'mFG2hDv4lsrij8uGCMP+'."\n".'-----END PRIVATE KEY-----'."\n".'',
            'cache.driver' => 'array',
            ...
            'modules_translation_paths' => [
                0 => (\dirname(__DIR__, 4).'/modules/ps_contactinfo/translations'),
                1 => (\dirname(__DIR__, 4).'/modules/ps_languageselector/translations'),
                2 => (\dirname(__DIR__, 4).'/modules/ps_shoppingcart/translations'),
                3 => (\dirname(__DIR__, 4).'/modules/ps_mainmenu/translations'),
                4 => (\dirname(__DIR__, 4).'/modules/ps_imageslider/translations'),
                5 => (\dirname(__DIR__, 4).'/modules/ps_featuredproducts/translations'),
                6 => (\dirname(__DIR__, 4).'/modules/dashactivity/translations'),
                7 => (\dirname(__DIR__, 4).'/modules/dashgoals/translations'),
                8 => (\dirname(__DIR__, 4).'/modules/dashproducts/translations'),
                9 => (\dirname(__DIR__, 4).'/modules/dashtrends/translations'),
                10 => (\dirname(__DIR__, 4).'/modules/gridhtml/translations'),
                11 => (\dirname(__DIR__, 4).'/modules/gsitemap/translations'),
                12 => (\dirname(__DIR__, 4).'/modules/pagesnotfound/translations'),
                13 => (\dirname(__DIR__, 4).'/modules/ps_brandlist/translations'),
                14 => (\dirname(__DIR__, 4).'/modules/ps_categoryproducts/translations'),
                15 => (\dirname(__DIR__, 4).'/modules/ps_crossselling/translations'),
                16 => (\dirname(__DIR__, 4).'/modules/ps_emailalerts/translations'),
            ...
            'kernel.secret' => '5Q7t3Cyf4EyJZ6OeDTAWiSYKL82XkcTcwfdiiVKkS37IEm1bfPTfcobWE7EwH8a7',
