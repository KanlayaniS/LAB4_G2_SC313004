<?php
/* Smarty version 4.3.1, created on 2024-01-30 20:12:48
  from 'module:ps_newproductsviewstemplateshookps_newproducts.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_65b8f5d038b2f7_90120165',
...
function content_65b8f5d038b2f7_90120165 (Smarty_Internal_Template $_smarty_tpl) {
?>
  ...
  <article class="product-miniature js-product-miniature" data-id-product="24" data-id-product-attribute="0">
    <div class="thumbnail-container">
      <div class="thumbnail-top">
              ...
              <picture>
                                                <img
                  src="http://localhost/se_project/Project/31-home_default/kku-shrit-aniversary-60-years.jpg"
                  alt="KKU Shrit aniversary 60 years"
                  loading="lazy"
                  data-full-size-image-url="http://localhost/se_project/Project/31-large_default/kku-shrit-aniversary-60-years.jpg"
                  width="250"
                  height="250"
                />
              </picture>
  ...
  <article class="product-miniature js-product-miniature" data-id-product="22" data-id-product-attribute="0">
    <div class="thumbnail-container">
      <div class="thumbnail-top">
              ...
              <picture>
                                                <img
                  src="http://localhost/se_project/Project/30-home_default/kku-souvenir.jpg"
                  alt="KKU Souvenir"
                  loading="lazy"
                  data-full-size-image-url="http://localhost/se_project/Project/30-large_default/kku-souvenir.jpg"
                  width="250"
                  height="250"
                />
              </picture>
  ...
  <article class="product-miniature js-product-miniature" data-id-product="21" data-id-product-attribute="0">
    <div class="thumbnail-container">
      <div class="thumbnail-top">
                      ...
                      <a href="http://localhost/se_project/Project/th/hna-hlak/21-kku-cup.html" class="thumbnail product-thumbnail">
              <picture>
                                                <img
                  src="http://localhost/se_project/Project/32-home_default/kku-cup.jpg"
                  alt="KKU Cup"
                  loading="lazy"
                  data-full-size-image-url="http://localhost/se_project/Project/32-large_default/kku-cup.jpg"
                  width="250"
                  height="250"
                />
              </picture>
      ...
      <div class="product-description">
                      ...
                      <h3 class="h3 product-title"><a href="http://localhost/se_project/Project/th/hna-hlak/21-kku-cup.html" content="http://localhost/se_project/Project/th/hna-hlak/21-kku-cup.html">KKU Cup</a></h3>
...
<div class="product-list-reviews" data-id="21" data-url="http://localhost/se_project/Project/th/module/productcomments/CommentGrade">
  <div class="grade-stars small-stars"></div>
  <div class="comments-nb"></div>
</div>
  ...
  <article class="product-miniature js-product-miniature" data-id-product="20" data-id-product-attribute="0">
    <div class="thumbnail-container">
      <div class="thumbnail-top">
              ...
              <picture>
                                                <img
                  src="http://localhost/se_project/Project/28-home_default/kku-t-shirt.jpg"
                  alt="KKU T-shirt"
                  loading="lazy"
                  data-full-size-image-url="http://localhost/se_project/Project/28-large_default/kku-t-shirt.jpg"
                  width="250"
                  height="250"
                />
              </picture>
...
<div class="product-list-reviews" data-id="20" data-url="http://localhost/se_project/Project/th/module/productcomments/CommentGrade">
  ...
  <a class="all-product-link float-xs-left float-md-right h4" href="http://localhost/se_project/Project/th/สินค้าใหม่">
    ดูสินค้าใหม่ทั้งหมด<i class="material-icons">&#xE315;</i>
  </a>
</section>
